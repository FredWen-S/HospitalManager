...
4. 进入“数据统计分析”，查看近 20 天挂号人数、挂号科室人数、患者性别比例和年龄段分布图表。

## 报告 PDF 演示

1. 医生登录后进入今日挂号列表。
2. 处理一个挂号单，填写病因，选择药品和检查项目并提交。
3. 患者登录后进入“我的挂号”。
4. 对已完成且已缴费的挂号单点击“查看”，浏览器会打开 `/patient/pdf?oId=挂号单号`。
5. PDF 内容来自 `orders` 表中的症状、检查、药品、费用、医生意见，以及患者基础信息。
