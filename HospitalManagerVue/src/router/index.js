...
import SmartGuidance from "@/views/SmartGuidance.vue";
...
const routes = [
  ...
  },
  {
    ...
    },
    {
      ...
      {
        path: '/myappointment',
        name: 'MyAppointment', // 使用PascalCase命名
        component: () => import('@/views/Myappointment.vue'),
        meta: {
          requiredRoles: ['patient'] // 明确权限要求
        }
      },
    ...
    {
      path: "/guidanceRules",
      component: GuidanceRuleList,
      meta: {
        requireAuth: true,
      },
    },
    {
      path: "/guidanceStatistics",
      component: GuidanceStatistics,
      meta: {
        requireAuth: true,
      },
    },
  ...
  },
  {
    ...
    children:[
      ...
      {
        path: "/patient/guidance",
        component: SmartGuidance
      },
      {
