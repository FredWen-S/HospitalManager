    ...
    <el-header>
      <div class="words">
        <span @click="menuClick('patientLayout')" style="font-size: 22px">
          <i class="iconfont icon-r-love" style="font-size: 26px">医院挂号预约</i>
        </span>
      </div>
      <div class="words">
    ...
    <el-container>
      ...
      <el-aside width="200px">
        ...
        >
          ...
          <el-menu-item
            index="/patient/guidance"
            @click="menuClick('/patient/guidance')"
            style="font-size: 20px"
          >
            <i class="iconfont icon-r-love" style="font-size: 22px"></i>
            智能导诊
          </el-menu-item>
          <el-menu-item
            index="myOrder"
...
export default {
  ...
  methods: {
    ...
    menuClick(path) {
      ...
      setActivePath(path);
      const targetPath = path.charAt(0) === "/" ? path : "/" + path;
